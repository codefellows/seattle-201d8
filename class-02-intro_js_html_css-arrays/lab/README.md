...
- Your assignment will be to create an "About Me" HTML and JS project, and to also get started on your Learning Journal. These will be two separate projects that will live in two separate Git/GitHub repositories
...
- The questions in the guessing game must require a mix of yes/no answers, and user input must accept either y/n or yes/no responses, with either .toUpperCase() or .toLowerCase() used to validate the user input.
